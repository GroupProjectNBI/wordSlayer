...
- Name: e2e\ui\features\playgame.feature.spec.js >> PlayGame Page >> Overlay is visible when only one player is present and disappears when two players are present
- Location: .features-gen\e2e\ui\features\playgame.feature.spec.js:89:7
...
Call log:
  - waiting for getByRole('button', { name: /Motståndare anslöt/i })
