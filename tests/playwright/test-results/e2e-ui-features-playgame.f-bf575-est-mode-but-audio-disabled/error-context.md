...
- Name: e2e\ui\features\playgame.feature.spec.js >> PlayGame Page >> Music button visible in test mode but audio disabled
- Location: .features-gen\e2e\ui\features\playgame.feature.spec.js:146:7

# Error details

```
Error: Expected to see button "Mute Music"
```
...
```yaml
- generic [ref=e3]:
  - button "Motståndare anslöt" [ref=e4]
  - main [ref=e5]:
