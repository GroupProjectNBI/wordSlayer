...
- Name: e2e\ui\features\join_game.feature.spec.js >> JoinGame >> User navigates to Join Game page
- Location: .features-gen\e2e\ui\features\join_game.feature.spec.js:6:7
...
- main [ref=e3]:
  - generic [ref=e4]:
    - heading "Join Game" [level=1] [ref=e5]
    - generic [ref=e6]:
      - textbox "Enter code" [ref=e7]
      - button "Join" [ref=e8]
```
