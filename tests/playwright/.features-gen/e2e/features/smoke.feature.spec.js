...
test.describe('Smoke', () => {
  ...
  test('Startsidan går att öppna', async ({ Given, Then, page }) => { 
    ...
    await Then('ska jag se sidans titel innehåller "MinApplikation"', null, { page }); 
  });
