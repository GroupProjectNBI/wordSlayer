...
test.describe('HomePage', () => {
  ...
  test('User sees homepage', async ({ Given, Then, And, page }) => { 
    ...
    await And('I see button "Welcome message"', null, { page }); 
  });
