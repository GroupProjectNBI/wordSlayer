...
const bddFileData = [ // bdd-data-start
  ...
  {"pwTestLine":81,"pickleLine":71,"tags":[],"steps":[{"pwStepLine":82,"gherkinStepLine":72,"keywordType":"Context","textWithKeyword":"Given I intercept game session response with only one player","stepMatchArguments":[]},{"pwStepLine":83,"gherkinStepLine":73,"keywordType":"Context","textWithKeyword":"And I go to \"/game/test-session-id\"","stepMatchArguments":[{"group":{"start":8,"value":"\"/game/test-session-id\"","children":[{"start":9,"value":"/game/test-session-id","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":84,"gherkinStepLine":74,"keywordType":"Outcome","textWithKeyword":"Then I see the overlay","stepMatchArguments":[]},{"pwStepLine":85,"gherkinStepLine":75,"keywordType":"Action","textWithKeyword":"When I simulate a second player joining","stepMatchArguments":[]},{"pwStepLine":86,"gherkinStepLine":76,"keywordType":"Outcome","textWithKeyword":"Then I do not see the overlay","stepMatchArguments":[]}]},
  {"pwTestLine":89,"pickleLine":79,"tags":[],"steps":[{"pwStepLine":90,"gherkinStepLine":80,"keywordType":"Context","textWithKeyword":"Given I intercept game session response","stepMatchArguments":[]},{"pwStepLine":91,"gherkinStepLine":81,"keywordType":"Context","textWithKeyword":"And I go to \"/game/test-session-id\"","stepMatchArguments":[{"group":{"start":8,"value":"\"/game/test-session-id\"","children":[{"start":9,"value":"/game/test-session-id","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":92,"gherkinStepLine":82,"keywordType":"Outcome","textWithKeyword":"Then I do not see the overlay","stepMatchArguments":[]}]},
]; // bdd-data-end