...
test.describe('JoinGame', () => {
  ...
  test('User navigates to Join Game page', async ({ Given, When, Then, page }) => { 
    ...
    await Then('I should be redirected to the "Join Game" page', null, { page }); 
  });
